...
namespace SolEngine::GUI
{
	...
	static constexpr const char* LABEL_GAME_OF_LIFE_MIN_LIVE_NEIGHBOURS  { "Min. Live Neighbours" };
	static constexpr const char* LABEL_GAME_OF_LIFE_MAX_LIVE_NEIGHBOURS  { "Max. Live Neighbours" };
	static constexpr const char* LABEL_GAME_OF_LIFE_REPRO_LIVE_NEIGHBOURS{ "Repro. Live Neighbours" };
