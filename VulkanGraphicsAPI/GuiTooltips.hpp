...
namespace SolEngine::GUI
{
	...
	static constexpr const char* TOOLTIP_MIN_LIVE_NEIGHBOURS	{ "Cells with LESS than %zu Live Cell(s) will die NEXT Generation.\n(Cannot exceed or equal Maximum Live Neighbours)." };
	static constexpr const char* TOOLTIP_MAX_LIVE_NEIGHBOURS	{ "Cells with MORE than %zu Live Cell(s) will die NEXT Generation.\n(Cannot receed or equal Minimum Live Neighbours)." };
}